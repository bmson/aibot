...
- Fix the mobile bootstrap memory failure and mobile cost index found by the private web canary, then repeat authenticated reads against the imported history.
